...
# -*- coding: utf-8 -*-
#
# Smart Rest Client documentation build configuration file, created by
...
from smart_rest_client import __version__
...
htmlhelp_basename = 'smart-rest-client-doc'
...
latex_documents = [
    (master_doc, 'ApiClient.tex', 'Smart Rest Client Documentation',
...
man_pages = [
    (master_doc, 'ApiClient', 'Smart Rest Client Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ApiClient', 'Smart Rest Client Documentation',
     author, 'ApiClient',
     'Smart API Client is an Wrapper to perform requests to Rest APIs using objects to request endpoints and their methods',
     'Miscellaneous'),
]
